...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="admin/asset/css/animate.min.css">
    <link rel="stylesheet" type="text/css" href="admin/asset/css/bootstrap-switch.min.css">
    <link rel="stylesheet" type="text/css" href="admin/asset/css/checkbox3.min.css">
    <link rel="stylesheet" type="text/css" href="admin/asset/css/query.dataTables.min.css">
    <link rel="stylesheet" type="text/css" href="admin/asset/css/dataTables.bootstrap.css">
    <link rel="stylesheet" type="text/css" href="admin/asset/css/select2.min.css">
    <!-- CSS App -->
...
<body class="flat-blue">
                ...
                <div class="side-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            $q=mysql_query("SELECT * FROM menu order by kd_menu DESC LIMIT 6");
                            while($r=mysql_fetch_array($q)){                                            
                            $nama=substr($r['nama_menu'],0,250);
                            $deskripsi=substr($r['deskripsi'],0,250);
                            ?>

                            <!-- tanda -->
                                <div class="col-md-4 col-sm-12">
                                    <div class="thumbnail no-margin-bottom">
                                        <img src=<?php echo "img/menu/$r[gambar]"; ?> class="img-responsive">
                                        <div class="caption">
    ...
    <!-- Javascript Libs -->
            ...
            <script type="text/javascript" src="admin/asset/js/Chart.min.js"></script>
            <script type="text/javascript" src="admin/asset/js/bootstrap-switch.min.js"></script>
            <script type="text/javascript" src="admin/asset/js/jquery.matchHeight-min.js"></script>
            <script type="text/javascript" src="admin/asset/js/jquery.dataTables.min.js"></script>
            <script type="text/javascript" src="admin/asset/js/dataTables.bootstrap.min.js"></script>
            <script type="text/javascript" src="admin/asset/js/select2.full.min.js"></script>
            <script type="text/javascript" src="admin/asset/js/ace/ace.js"></script>
            <script type="text/javascript" src="admin/asset/js/ace/mode-html.js"></script>
            <script type="text/javascript" src="admin/asset/js/ace/theme-github.js"></script>
            <!-- Javascript -->
