                                        ...
                                        <!-- tambah bagian kerja -->
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form class="form-horizontal" action="simpan_bagian_kerja.php" method="post">
                                        ...
                                        if($hasil != null){
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="hapus_bagian_kerja.php?page=hapus_bagian_kerja&id=<?php echo $kolom['kd_bagian'];?>"onclick="return confirm('apakah yakin menghapus data ?')" ><button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span></button></a>
                                                </td>
                                            </tr>
                                            <?php 
                                            }
