...
if ($sql1) {
    echo "<meta http-equiv='refresh' content='0; url=indexuser.php?page=detail_kredit&id=$nf'>";
} else {
                    ...
                    <div>
                       ...
                       <tr>
                        ...
                        <div class="form-action no-margin-bottom" style="margin-left:40%">
                            ...
                            <a href="indexuser.php?page=detail_kredit&id=<?php echo "$nf"; ?>" class="btn btn-primary">BATAL EDIT</a>
                        </div>
                        <br>
                        </form>
