                                        ...
                                        <!-- tambah bagian kerja -->
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form class="form-horizontal" action="pengolahan_menu/simpan_menu.php" method="post" enctype="multipart/form-data" name="FormUpload" id="FormUpload">
                                        ...
                                        if($hasil != null){
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="pengolahan_menu/hapus_menu.php?page=hapus_menu&id=<?php echo $kolom['kd_menu'];?>"onclick="return confirm('apakah yakin menghapus data ?')" ><button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span></button></a>
                                                </td>
                                            </tr>
                                            <?php 
                                            }
